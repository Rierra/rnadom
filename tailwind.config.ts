  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "brand-glow": {
          "0%, 100%": { filter: "drop-shadow(0 0 20px hsl(0 0% 70% / 0.4))" },
          "50%": { filter: "drop-shadow(0 0 40px hsl(0 0% 70% / 0.6))" },
        },
      },
      animation: {
      ...
      boxShadow: {
        luxury: "0 25px 50px -12px hsl(0 0% 0% / 0.25)",
        silver: "0 10px 40px -10px hsl(0 0% 50% / 0.3)",
      },
    },
  },
